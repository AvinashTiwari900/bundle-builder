          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/80 space-y-2 text-xs">
              ...
              <p className="text-slate-600 leading-relaxed font-medium">
                Whenever RAS identifies and applies to an eligible job on your behalf, an automated confirmation is dispatched via <strong>HTML Email</strong> and <strong>WhatsApp Message</strong> containing the company name, role, application date, match score, and status.
              </p>
